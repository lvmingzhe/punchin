...
# 参数设置1
chrome_driver = 'd:\punchin-master\chromedriver.exe'
phone_num = '18737320505'
password = '528013'
pushplus_token = '9dc95737fd8644b583650c7a82fe04e4'
...
def login(driver,url):
    ...
    try:
        #************************
        win32api.keybd_event(32,0,0,0)  #space button
    ...
    login_btn.click()
    #************************
    win32api.keybd_event(33,0,0,0)  #PageUp button
